...
/// <summary>
/// A publisher's clean-shutdown withdrawal. Sent on the control topic during graceful
...
/// </summary>
internal sealed record PublisherLeave
{
    /// <summary>The data-topic this publisher is leaving.</summary>
